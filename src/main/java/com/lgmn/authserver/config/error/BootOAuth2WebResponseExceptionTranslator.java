package com.lgmn.authserver.config.error;
...
public class BootOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        if (ase instanceof UsernameNotFoundException) {
            return handleOAuth2Exception(new BootOAuth2WebResponseExceptionTranslator.UserNotFind(ase.getMessage(), ase));
        }
    ...
    private static class UserNotFind extends OAuth2Exception {

        public UserNotFind(String msg, Throwable t) {
            super(msg, t);
        }
